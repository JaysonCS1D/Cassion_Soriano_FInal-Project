...
def speak_message(message):
    try:
        ...
        engine.say(message)
        engine.runAndWait()
        engine.stop()  # Stop the engine after speaking the message to conserve resources
    except ImportError:
        print("pyttsx3 is not installed. Speech functionality disabled.")

def draw_welcome_design():
    turtle.speed(1)  # Set the drawing speed to maximum
    turtle.color("blue")
    turtle.pensize(3)
    turtle.penup()
    turtle.goto(-200, 150)
